...
<body>
    ...
    <section>
        <div class="container-xl" id="=">
            ...
            <div class="table-responsive-xl mt-4" id="container_srtmsk">
    ...
    <div class="modal fade" id="ganti_judul_srtmsk" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="gantiJudul" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        <input type="hidden" value="<?= $judul_srtmsk["id_komponen"]; ?>" name="id_judul">
                        <div class="mb-4">
                            <label for="judul_srtmsk" class="form-label">Judul Surat Masuk</label>
                            <input type="text" class="form-control" id="judul_srtmsk"  name="judul_srtmsk" required autocomplete="off" autofocus value="<?= $judul_srtmsk["isi_komponen"]; ?>">
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
